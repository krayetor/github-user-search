...
const SkeletonCard = () => {
    return (
        <div className="bg-white dark:bg-slate-800 p-6 rounded-lg border border-gray-200 dark:border-slate-700 shadow-md flex items-start gap-4 animate-pulse">
            ...
            <div className="flex-1 space-y-3 py-1">
                ...
                {/* button skeleton */}
                <div className="h-8 bg-gray-200 dark:bg-slate-700 rounded w-24 mt-2" />
            </div>
        </div>
    );
};
